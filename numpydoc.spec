...
%prep
%setup -q -n numpydoc-0.9.2
cd %{_builddir}/numpydoc-0.9.2
...
cp %{_builddir}/numpydoc-0.9.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/numpydoc/df4f727b25238b8a4be050714fe3f1cb06b17f75
